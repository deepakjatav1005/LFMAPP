...
import { formatDateDDMMYYYY, triggerPrint, openInStandaloneTab, downloadElementAsPDF, getCleanOfficeTitle } from '../utils/printUtils';
            ...
            <div className="flex items-center justify-between gap-3 print:hidden pt-3 border-t border-slate-200 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  onClick={async () => {
                    if (selectedBookingForPrint) {
                      await downloadElementAsPDF('booking-receipt-print-area', `BookingReceipt_${selectedBookingForPrint.voucherNo || selectedBookingForPrint.id}`, 'portrait');
                    }
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    if (selectedBookingForPrint) {
                      openInStandaloneTab('booking-receipt-print-area', `BookingReceipt_${selectedBookingForPrint.voucherNo || selectedBookingForPrint.id}`, 'portrait');
                    }
                  }}
                ...
                <button
                  type="button"
                  onClick={() => triggerPrint('booking-receipt-print-area', { orientation: 'portrait', title: `BookingReceipt_${selectedBookingForPrint?.voucherNo}` })}
